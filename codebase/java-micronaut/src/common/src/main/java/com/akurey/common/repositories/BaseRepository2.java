...
public abstract class BaseRepository2 {
  ...
  protected <TResult extends BaseSPResult> TResult getSingleResult(String spName, List<SPParam> params, Class<TResult> resultClass)
      throws AKException {
  ...
  @SuppressWarnings("unchecked")
  protected <TResult extends BaseSPResult> List<TResult> getResultList(String spName, List<SPParam> params, Class<TResult> resultClass)
      throws AKException {
